...
import { tiposAutenticacion } from './auth/types';
...
export const tipos = [tiposGlobales, tiposEnums, tiposProyecto, tiposUsuarios, tiposAvance, tiposInscripcion, tiposAutenticacion];